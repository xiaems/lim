...
const styles = StyleSheet.create({
  ...
  goBackBtn: { position: 'absolute', bottom: windowHeight(20), right: 0, left: 0, marginHorizontal: windowWidth(20) },
  view: { flex: 1 },
  mainView: { marginHorizontal: windowWidth(20), marginTop: windowHeight(15) },
});
